...
void NodeSLList_Test()
{
	...
	cout << "*****************************************************************************" << endl;
	cout << "Adding " << n5.data << " to list2" << endl;
	list3.AddToTail(n5);
	cout << "Adding " << n4.data << " to list2" << endl;
	list3.AddToTail(n4);
	cout << "Adding " << n3.data << " to list2" << endl;
	list3.AddToTail(n3);
	cout << "Adding " << n2.data << " to list2" << endl;
	list3.AddToTail(n2);
	cout << "Adding " << n1.data << " to list2" << endl;
	list3.AddToTail(n1);
	...
	cout << "*****************************************************************************" << endl;
	cout << "Testing operator+ by list1+list2" << endl;
	cout << "*****************************************************************************" << endl;
	cout << "list1:" << endl;
	cout << list1 << endl;
	cout << "list2:" << endl;
	...
	list2.InsertNode(2, ad);
	cout << "cout << list2 " << endl;
	cout << list2 << endl;
	cout << "add node 0" << endl;
	list2.InsertNode(0, ad);
	cout << "cout << list2 " << endl;
	cout << list2 << endl;
	...
	cout << "*****************************************************************************" << endl;
	cout << "before sorting list 2:"<<endl;
	cout << list3 << endl;
	...
	cout << "*****************************************************************************" << endl;
	cout << "before sorting list 3:" << endl;
	cout << list3 << endl;
	cout << "after sorting:" << endl;
	list3.SortList(2);
	cout << list3 << endl;
